...
export const groupData = [     
            ...
            { group:2, position: 3, teamName: "USA"},
            { group:8, position: 3, teamName: "Uruguay"},
            { group:2, position: 4, teamName: "Wales"},
        ];
